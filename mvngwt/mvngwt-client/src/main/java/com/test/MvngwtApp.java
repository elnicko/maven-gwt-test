 ...
 */
public class MvngwtApp implements EntryPoint {
	/**
	 ...
	 */
	private final MvngwtAppFactory factory = GWT.create(MvngwtAppFactory.class);
	...
	public void onModuleLoad() {
		...
		nameField.setText("GWT User " + new MvngwtApi().hello());
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				factory.greeting().greetServer(textToServer).fire(
						new Receiver<GreetingResponseProxy>() {
							...
							private void showFailureMessage() {
								dialogBox
										.setText("Request Factory Call - Failure");
								serverResponseLabel
